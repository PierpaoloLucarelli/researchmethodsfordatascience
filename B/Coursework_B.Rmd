...
pairwise.t.test( transferLearners_Bad_TeD$score , transferLearners_Bad_TeD$model,p.adjust.method = "none", pool.sd = FALSE)
pairwise.t.test( transferLearners_Good_TeD$score , transferLearners_Good_TeD$model, p.adjust.method = "none", pool.sd = FALSE)
...
```{r}
#RQ3:
singleLearners_Bad_TeD  = singleDataTransferLearner[singleDataTransferLearner$TeD == 'TeD5' | singleDataTransferLearner$TeD == 'TeD7',]
singleLearners_Good_TeD = singleDataTransferLearner[singleDataTransferLearner$TeD != 'TeD5' | singleDataTransferLearner$TeD != 'TeD7',]
...
pairwise.t.test(singleLearners_Bad_TeD$score , singleLearners_Bad_TeD$train, p.adjust.method = "none", pool.sd = FALSE)
pairwise.t.test(singleLearners_Good_TeD$score , singleLearners_Good_TeD$train, p.adjust.method = "none", pool.sd = FALSE)
