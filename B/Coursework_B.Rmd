...
pairwise.t.test( transferLearners_Bad_TeD$score , transferLearners_Bad_TeD$model,p.adjust.method = "BH", pool.sd = FALSE)
pairwise.t.test( transferLearners_Good_TeD$score , transferLearners_Good_TeD$model, p.adjust.method = "BH", pool.sd = FALSE)
...
pairwise.t.test(singleLearners_Bad_TeD$score , singleLearners_Bad_TeD$train, p.adjust.method = "BH", pool.sd = FALSE)
pairwise.t.test(singleLearners_Good_TeD$score , singleLearners_Good_TeD$train, p.adjust.method = "BH", pool.sd = FALSE)
